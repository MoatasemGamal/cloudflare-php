...
{
    public function testListLockdowns(): void
    {
    ...
    public function testAddLockdown(): void
    {
    ...
    public function testGetRecordDetails(): void
    {
    ...
    public function testUpdateLockdown(): void
    {
        $config = new \Cloudflare\API\Configurations\ZoneLockdown();
        $config->addIP('1.2.3.4');
    ...
    public function testDeleteLockdown(): void
    {
        $config = new \Cloudflare\API\Configurations\ZoneLockdown();
        $config->addIP('1.2.3.4');
