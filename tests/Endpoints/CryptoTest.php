...
{
    public function testGetOpportunisticEncryptionSetting(): void
    {
    ...
    public function testGetOnionRoutingSetting(): void
    {
    ...
    public function testUpdateOpportunisticEncryptionSetting(): void
    {
    ...
    public function testUpdateOnionRoutingSetting(): void
    {
