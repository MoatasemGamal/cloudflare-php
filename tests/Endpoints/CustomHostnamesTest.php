...
{
    public function testAddHostname(): void
    {
    ...
    public function testListHostnames(): void
    {
    ...
    public function testUpdateHostname(): void
    {
    ...
    public function testDeleteHostname(): void
    {
    ...
    public function testGetHostnameFallbackOrigin(): void
    {
    ...
    private function getCustomSsl(): array
    {
        ...
        $customCertificate = <<<CERTIFICATE_WRAP
            -----BEGIN CERTIFICATE-----
